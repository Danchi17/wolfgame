...
const ROLES = {
  ...
  SPY: {
    ...
    team: 'village',
    cost: 2,
    description: '狼のターン時に人狼陣営とお互いを確認できる。スパイ通報ボタンが設置され、バレると市民陣営が強制敗北となる。'
  },
  ...
  WEREWOLF: {
    ...
    team: 'werewolf',
    cost: 5,
    description: '自身が吊られた時、プレイヤーの過半数が人狼サイドなら強制勝利する（スパイは人狼陣営に含まない）'
  },
  SEER_WOLF: {
    name: '占い人狼',
    team: 'werewolf',
  ...
  TROUBLESOME_PIG: {
    ...
    team: 'werewolf',
    cost: 3,
    description: '任意の他のプレイヤー1人に★マークを付与する。★マークは1分間で消滅する。'
  },
  SNAKE_WOMAN: {
    name: '蛇女',
    team: 'werewolf',
  ...
  KNOWLEDGEABLE_PUPPY: {
    ...
    team: 'werewolf',
    cost: 3,
    description: '日中のターンに市民陣営の特定の役職を当てることが出来れば、人狼陣営の勝利となる。'
  }
};
